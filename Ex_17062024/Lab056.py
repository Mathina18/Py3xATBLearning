...
result0 = sum_number_argument_ret(3, 4)
result1 = sum_number_argument_ret(31, 43)
result2 = sum_number_argument_ret(a=90, b=89)
result3 = sum_number_argument_ret(b=101, a=99)
print(result0)
print(result1)
print(result2)
print(result3)